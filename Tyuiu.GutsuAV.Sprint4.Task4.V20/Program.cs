...
using Tyuiu.GutsuAV.Sprint4.Task4.V20.Lib;

namespace Tyuiu.GutsuAV.Sprint4.Task4.V20
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* значениями с клавиатуры от 4 до 8.Заменить четные элементы массива на 1.*");
            Console.WriteLine("*                                                                         *");
